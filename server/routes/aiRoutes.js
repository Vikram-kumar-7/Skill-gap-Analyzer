...
router.post('/chat', async (req, res) => {
  ...
  if (!key || key === 'your_openai_api_key_here' || key === 'your_openrouter_api_key_here') {
          ...
          messages: [
            {
              role: 'system',
              content:
                'You are a resume expert. Return JSON: {"improved": [string, string, string]}',
            },
            {
              role: 'user',
          ...
          messages: [
            {
              role: 'system',
              content:
                'Write a professional 3-sentence resume summary. Return JSON: {"summary": string}',
            },
            {
              role: 'user',
