...
export const getUser = () =>
  JSON.parse(localStorage.getItem('sga_user') || 'null');
...
export const getAnalyses = () =>
  JSON.parse(localStorage.getItem('sga_analyses') || '[]');
...
export const getSkills = () =>
  JSON.parse(localStorage.getItem('sga_skills') || '[]');

export const saveSkills = (arr) =>
  localStorage.setItem('sga_skills', JSON.stringify(arr));

export const getProjects = () =>
  JSON.parse(localStorage.getItem('sga_projects') || '[]');

export const saveProjects = (arr) =>
  localStorage.setItem('sga_projects', JSON.stringify(arr));

export const getActivity = () =>
  JSON.parse(localStorage.getItem('sga_activity') || '[]');
